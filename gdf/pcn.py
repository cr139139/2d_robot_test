...
class PCNENC(nn.Module):
    def __init__(self):
        super().__init__()

        full_model = PCN()
        full_model.load_state_dict(torch.load('best_l1_cd.pth'))
        ...
        self.first_conv.load_state_dict(layers[0].state_dict())
        self.second_conv.load_state_dict(layers[1].state_dict())
